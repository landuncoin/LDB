...
RESOURCES += src/qt/ldbcoin.qrc src/qt/ldbcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ldbcoin_bg.ts \
                src/qt/locale/ldbcoin_de.ts \
                src/qt/locale/ldbcoin_en.ts \
                src/qt/locale/ldbcoin_es.ts \
                src/qt/locale/ldbcoin_fi.ts \
                src/qt/locale/ldbcoin_fr.ts \
                src/qt/locale/ldbcoin_it.ts \
                src/qt/locale/ldbcoin_ja.ts \
                src/qt/locale/ldbcoin_pl.ts \
                src/qt/locale/ldbcoin_pt.ts \
                src/qt/locale/ldbcoin_ru.ts \
                src/qt/locale/ldbcoin_sk.ts \
                src/qt/locale/ldbcoin_sv.ts \
                src/qt/locale/ldbcoin_vi.ts \
                src/qt/locale/ldbcoin_zh_CN.ts \
                src/qt/locale/ldbcoin_zh_TW.ts
