...
// Copyright (c) 2018-2019 The LDB Core developers
...
{
    /* current difficulty formula, ldbcoin - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
    ...
    int64_t _nTargetTimespan = CountBlocks * (pindexLast->nHeight > 500000 ? Params().TargetSpacing() : Params().TargetSpacingSlowLaunch());
