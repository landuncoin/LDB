 ...
 * ldbcoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& ldbcoinDevKey() const { return vldbcoinDevKey; }
    // const std::vector<unsigned char>& ldbcoinFundKey() const { return vldbcoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vldbcoinDevKey;
    // std::vector<unsigned char> vldbcoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
