...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 0.5 * 60;  // 0.5 minute after 500K
        nTargetSpacingSlowLaunch = 1 * 60; // before block 500k
        ...
        //vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("seed1.landun.pro", "seed2.landun.pro"));
        vSeeds.push_back(CDNSSeedData("seed3.landun.pro", "seed4.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed5.landun.pro", "seed6.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed7.landun.pro", "seed8.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed9.landun.pro", "seed10.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed11.landun.pro", "seed12.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed13.landun.pro", "seed14.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed15.landun.pro", "seed16.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed17.landun.pro", "seed18.landun.pro"));
		vSeeds.push_back(CDNSSeedData("seed19.landun.pro", "seed20.landun.pro"));
        ...
        strDevFeeAddress = "LaaqTgC3bzbyEgAZ5fJZWbsAB5QQbudhjk";
        ...
        strObfuscationPoolDummyAddress = "LaaqTgC3bzbyEgAZ5fJZWbsAB5QQbudhjk";
...
//        nLastPOWBlock = std::numeric_limits<decltype(nLastPOWBlock)>::max();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet ldbcoin addresses start with 'x'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ldbcoin script addresses start with '8' or '9'
        ...
        strDevFeeAddress = "LhWtbyXz6MEtNWmd5QtBASQSdHsAVJFcmM";
        ...
        strObfuscationPoolDummyAddress = "LhWtbyXz6MEtNWmd5QtBASQSdHsAVJFcmM";
