...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ldb features */
        {"ldb", "masternode", &masternode, true, true, false},
        {"ldb", "listmasternodes", &listmasternodes, true, true, false},
        {"ldb", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ldb", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ldb", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ldb", "masternodedebug", &masternodedebug, true, true, false},
        {"ldb", "startmasternode", &startmasternode, true, true, false},
        {"ldb", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ldb", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ldb", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ldb", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ldb", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ldb", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ldb", "mnsync", &mnsync, true, true, false},
        {"ldb", "spork", &spork, true, true, false},
        {"ldb", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ldb", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ldbcoind, or the -server option to ldbcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"ldb Alert\" admin@foo.com\n"),
...
{
    return "> ldbcoin-cli " + methodname + " " + args + "\n";
}
