...
QFontDatabase::addApplicationFont(":/fonts/ldbcoin_font");

QString windowTitle = tr("LDB") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LDB address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and LDB: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LDB wallet"), this);
    aboutAction->setStatusTip(tr("Show information about LDB wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LDB wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LDB addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LDB addresses"));
    ...
    openAction->setStatusTip(tr("Open a LDB: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LDB help message to get a list with possible LDB command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LDB client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LDB network", "", count));
}
...
{
    QString strTitle = tr("LDB"); // default title
