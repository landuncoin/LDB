...
// Copyright (c) 2017-2018 The ldbcoin Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(LDB);
   // unitlist.append(mLDB);
   // unitlist.append(uLDB);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case LDB:
            return QString("LDB");
        case mLDB:
            return QString("Milli-LDB (1 / 1" THIN_SP_UTF8 "000)");
        case uLDB:
            return QString("Micro-LDB (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case LDB:
            return QString("TestLDBs");
        case mLDB:
            return QString("Milli-TestLDBs (1 / 1" THIN_SP_UTF8 "000)");
        case uLDB:
            return QString("Micro-TestLDBs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
