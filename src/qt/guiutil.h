...
/** Utility functions used by the ldbcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ldbcoin addresses in monospace font
...
// Parse "ldbcoin:" URI into recipient object, return true on successful parsing
