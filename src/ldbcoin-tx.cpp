...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LDB Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ldbcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ldbcoin transaction") + "\n" +
                               "  ldbcoin-tx [options] -create [commands]   " + _("Create hex-encoded ldbcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ldbcoin transaction
