...
In order to support loading of multiple wallets in ldbcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ldbcoin.cpp.
...
Changes to ldbcoin.cpp
----------------------
ldbcoin.cpp is the entry point into ldbcoin-qt, and as such, will require some minor modifications to provide hooks for
