...
* WebSocket: [https://github.com/ldbcoin-Core/insight-api-ldbcoin#web-socket-api](https://github.com/ldbcoin-Core/insight-api-ldbcoin#web-socket-api)
* API: [https://github.com/ldbcoin-Core/insight-api-ldbcoin#swifttx-transactions](https://github.com/ldbcoin-Core/insight-api-ldbcoin#swifttx-transactions)
...
By default, the ldbcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ldbcoin Core daemon:
